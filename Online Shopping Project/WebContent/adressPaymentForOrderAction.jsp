...
try
{
	...
	PreparedStatement ps1=con.prepareStatement("update cart set adress=?,city=?,state=?,country=?,mobileNumber=?,orderDate=now(),deliveryDate=DATE_ADD(orderDate,INTERVAL 7 DAY),paymentMethod=?,transactionId=?,status=? where email=? and adress is NULL");
