...
<title>add or change adress</title>
</head>
<body>
<%
...
%>
<form action="addChangeAdressAction.jsp" method="post">
<h3>Enter Address</h3>
 <input class="input-style" type="text" name="adress" value="<%=rs.getString(7)%>" placeholder="Enter Adress" required>
 <hr>
 <h3>Enter city</h3>
