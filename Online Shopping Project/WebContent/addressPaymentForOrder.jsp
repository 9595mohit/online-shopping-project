...
<hr style="width: 100%">
<form action="adressPaymentForOrderAction.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
<input class="input-style" type="text" name="adress" value="<%=rs2.getString(7)%>" placeholder="Enter adress" required>
 </div>
...
<div class="right-div">
<h3>Pay online on this mohitkasar@ybl.com</h3>
